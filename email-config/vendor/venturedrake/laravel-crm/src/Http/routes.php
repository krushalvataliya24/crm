...
/* email-config */
Route::group(['prefix' => 'email-config', 'middleware' => 'auth.laravel-crm'], function () {

    Route::get('', 'VentureDrake\LaravelCrm\Http\Controllers\EmailConfigController@index')
        ->name('laravel-crm.email-config.index')
        ->middleware(['can:view crm email config,VentureDrake\LaravelCrm\Models\EmailConfig']);

    Route::get('create', 'VentureDrake\LaravelCrm\Http\Controllers\EmailConfigController@create')
        ->name('laravel-crm.email-config.create')
        ->middleware(['can:create crm email config,VentureDrake\LaravelCrm\Models\EmailConfig']);

    Route::post('', 'VentureDrake\LaravelCrm\Http\Controllers\EmailConfigController@store')
        ->name('laravel-crm.email-config.store')
        ->middleware(['can:create crm email config,VentureDrake\LaravelCrm\Models\EmailConfig']);

    Route::get('{email}', 'VentureDrake\LaravelCrm\Http\Controllers\EmailConfigController@show')
        ->name('laravel-crm.email-config.show')
        ->middleware(['can:view crm email config,emailConfig']); 

    Route::get('{email}/edit', 'VentureDrake\LaravelCrm\Http\Controllers\EmailConfigController@edit')
        ->name('laravel-crm.email-config.edit')
        ->middleware(['can:edit crm email config,emailConfig']);

    Route::put('{email}', 'VentureDrake\LaravelCrm\Http\Controllers\EmailConfigController@update')
        ->name('laravel-crm.email-config.update')
        ->middleware(['can:edit crm email config,emailConfig']);

    Route::delete('{email}', 'VentureDrake\LaravelCrm\Http\Controllers\EmailConfigController@destroy')
        ->name('laravel-crm.email-config.destroy')
        ->middleware(['can:delete crm email config,emailConfig']);
});
